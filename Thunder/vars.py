...
class Var:
    API_ID: int = get_int_env("API_ID", 0)
    ...
    MAX_BATCH_FILES: int = get_int_env("MAX_BATCH_FILES", 50)
    ...
    TOKEN_TTL_HOURS: int = get_int_env("TOKEN_TTL_HOURS", 24)
    ...
    MAX_GLOBAL_REQUESTS_PER_MINUTE: int = get_int_env("MAX_GLOBAL_REQUESTS_PER_MINUTE", 4)
